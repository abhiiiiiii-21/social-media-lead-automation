  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-semibold tracking-tight">Outreach Analytics</h1>
        <p className="text-muted-foreground">View your outreach metrics and performance.</p>
      </div>
